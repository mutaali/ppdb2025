...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt->execute([
        ...
        $_POST['asal_sekolah'], $_POST['jurusan1'], $_POST['jurusan2'], $_POST['alamat']
    ]);
...
<body class="bg-gray-100 p-6">
    <div class="max-w-2xl mx-auto bg-white p-6 rounded shadow">
        <h2 class="text-xl font-bold mb-4">Tambah Data Pendaftaran</h2>
            ...
            ?>
                <div>
                    ...
                    <?php elseif ($name === 'asal_sekolah'): ?>
                        <input name="asal_sekolah" class="w-full border rounded px-3 py-2" list="asal-sekolah-list" required>
